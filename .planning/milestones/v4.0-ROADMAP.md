...
Plans:
- [x] 47-01: Ditto operator and option/local reorder (LANG-01, LANG-05)
- [x] 47-02: Arrow operator and lambda functions (LANG-02)
- [x] 47-03: Fractional q-powers (LANG-04)
...
Plans:
- [x] 48-01: aqprod truncation fix and theta 2-arg signatures (FIX-01, FIX-02)
- [x] 48-02: qfactor 2-arg signature and min function (FIX-05, LANG-03)
...
Plans:
- [x] 49-01: qfactor product-form display (FIX-03)
- [x] 49-02: etamake eta-notation display (FIX-04)
...
Plans:
- [x] 50-01: jac2series overhaul and quinprod identity modes (FUNC-01, FUNC-03)
- [x] 50-02: radsimp and indexed subs (FUNC-02, FUNC-04)
...
Plans:
- [x] 51-01: Help entries and tab completion for all v4.0 features
- [x] 51-02: PDF manual v4.0 chapter with qmaple.pdf worked examples
...
**Key Decisions:**
- Ditto disambiguated via byte-lookahead, not parser-level context
- Arrow l_bp=2 matches assignment; lambda desugars to Value::Procedure
- FractionalPowerSeries auto-simplifies back to regular Series
- aqprod 3-arg uses POLYNOMIAL_ORDER for exact polynomials
- QProduct/EtaQuotient Value variants for human-readable display
- Indexed subs via name-mangling X[i], not separate AST node
- radsimp is identity (series division already simplifies)

**Issues Resolved:**
- All 14 qmaple.pdf parity gaps closed
- aqprod truncation, theta/qfactor signatures, display formatting, new functions

**Issues Deferred:**
- zqfactor (bivariate factoring), while-loops, nops/op
