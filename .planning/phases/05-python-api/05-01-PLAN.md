...
<task type="auto">
  ...
  <files>
  NOTE: This task modifies no source files. It installs tools (Python, maturin) and validates the build pipeline by running maturin develop and python import commands.
  </files>
  <action>
